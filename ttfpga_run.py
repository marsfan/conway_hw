...
print("\n")
print(f"{colors.color('TT SDK v' + tt.version, 'cyan')}")
print("\n\n")
gc.collect()
...
# tt.shuttle.tt_um_vga_example2.enable()
tt.shuttle.tt_um_conway.enable()

from ttboard.mode import RPMode

tt.mode = RPMode.ASIC_RP_CONTROL
tt.clock_project_PWM(25e6)
