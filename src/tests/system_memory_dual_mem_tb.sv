...
module system_memory_dual_mem_tb();
    ...
    system_memory_dual_mem #(DATA_SIZE) dut(
        .grid_in(grid_in),
        .serial_in(serial_in),
        .load_mode(load_mode),
        .run_mode(run_mode),
    ...
    initial begin
        ...
        // Dump to VCD File
        $dumpfile("waveforms/system_memory_dual_mem_tb.vcd");
        $dumpvars(0, system_memory_dual_mem_tb);
